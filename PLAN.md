...
| 5a. Memory writes | Persistent writes after every event (commitment-status open→met/missed transitions already landed in Phase 4B; Phase 5a inherits the residual write-after-every-event scope) | Multi-quarter synthetic run closes prior commitments correctly |
